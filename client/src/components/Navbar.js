    ...
    <div className="navbar">
      <div className="navbar__header">
        ...
        <div className="navbar__header__search">
          <input
            type="search"
            placeholder="Search for dresses or items"
            name=""
            id=""
            className="search"
          />
        ...
        <div
          className="navbar__header__cart"
      ...
      <div className="navbar__links">
        <NavLink to="/newarrivals" activeClassName="is-active">
          New Arrivals
        </NavLink>
        <NavLink to="/weddingdresses" activeClassName="is-active">
          Wedding dresses
        </NavLink>
        <NavLink to="/customattires" activeClassName="is-active">
          Custom Attires
        </NavLink>
        <NavLink to="/accessories" activeClassName="is-active">
          Accessories
        </NavLink>
        <NavLink to="/sale" activeClassName="is-active">
          Sale
        </NavLink>
